 ...
 * Read float
 */
float JC_EEPROM::readFloat(unsigned int address) {
	read(address, _b, 4);
	return *(float*)&_b[0];
}
 ...
 * Read double
 */
double JC_EEPROM::readDouble(unsigned int address) {
	read(address, _b, 8);
	return *(double*)&_b[0];
}
 ...
 * Read chars
 */
void JC_EEPROM::readChars(unsigned int address, char *data, int n) {
 ...
 * Write float
 */
void JC_EEPROM::writeFloat(unsigned int address, float data) {
	write(address, (byte*)&data, 4);
}
 ...
 * Write double
 */
void JC_EEPROM::writeDouble(unsigned int address, double data) {
 ...
 * Write chars
 */
void JC_EEPROM::writeChars(unsigned int address, char *data, int length) {
